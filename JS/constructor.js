...
function Recipe(name, fileName, ingredients, ingredientsDetail, direction, serves, time, fileExtenstion = 'jpeg') {
  this.name = name;
...
let fajitaVeggies = new Recipe(
  'Fajita Veggies',
  'FajitaVeggies',
  ['peppers', 'mushroom', 'onion', 'garlic', 'chili powder', 'cumin', 'balsamic vinegar', 'lime', 'tortillas'],
...
let porkStirFry = new Recipe(
  'Pork Stir Fry',
  'porkStirFry',
  ['pork', 'cooking wine', 'oyster sauce', 'corn starch', 'baking soda', 'soy sauce', 'honey', 'hoisin sauce', 'onion', 'peppers', 'carrot', 'mushroom', 'cashews', 'red chili flakes', 'garlic', 'ginger', 'snow peas'],
  ['1 lb pork', '5 tbsp water', '2 tsp cooking wine', '2 tbsp oyster sauce', '2 tsp corn starch', '3 tbsp oil', '1/2 tsp baking soda', '2 tbsp soy sauce', '2 tbsp honey', '1 tbsp hoisin sauce', '1 small onion', '3 bell peppers', '3 carrots', '6 oz mushrooms', '1/3 cup cashews', '1 tsp red chili flakes', '4 garlic cloves', '1 tbsp ginger', '6oz snow peas'],
...
let friedRice = new Recipe(
  'Chinese Fried Rice',
  'friedRice',
  ['rice', 'sesame oil', 'white onion', 'peas', 'carrot', 'soy sauce', 'egg', 'green onions'],
...
let broccoliPestoPasta = new Recipe(
  ...
  'broccoliPestoPasta',
  ['pasta', 'broccoli', 'basil', 'garlic', 'pine nuts', 'parmesan cheese'],
...
let chickenTortillaSoup = new Recipe(
  ...
  'chickenTortillaSoup',
  ['chicken stock', 'chicken', 'enchilada sauce', 'tomato', 'corn'],
...
let coconutCurryRamen = new Recipe(
  'Coconut Curry Ramen',
  'coconutCurryRamen',
  ['red curry paste', 'yellow curry powder', 'sesame oil', 'garlic', 'ginger', 'stock', 'coconut milk', 'green onions', 'ramen noodles', 'mushrooms', 'lime', 'bok choy', 'edamame'],
...
let chickenStirFry = new Recipe(
  'Chicken Stir Fry',
  'chickenStirFry',
  ['chicken breast', 'cornstarch', 'sesame oil', 'green beans', 'garlic', 'ginger', 'soy sauce', 'chili paste'],
  ['2 lb boneless, skinless chicken breast, cut into 2-inch cubes', '3 tbsp cornstarch', '1/4 cup toasted sesame oil', '3/4 lb green beans, trimmed and cut into 3" pieces', '3 large garlic cloves, minced', '1 tbsp minced, fresh ginger', '1/4 cup soy sauce or tamari', '1 tsp chili paste, (or 1/2 tsp red pepper flakes)', '1/4 tsp sea salt', 'sesame seeds, (optional)', 'minced cilantro, (optional)'],
...
let spamMusubi = new Recipe(
  'Spam Musubi',
  'spamMusubi',
  ['rice', 'spam', 'rice vinegar', 'oyster sauce', 'soy sauce', 'sugar', 'nori'],
